...
namespace EventCenter
{
    public partial class EventCenter
    {
        ...
        public void RemoveEventSystemType(EventSystemType eventSystemType)
        {
            ...
            {
                LogHelperLSK.LogError(string.Format("m_allEvent not Contains EventSystemType: {0}",eventSystemType));
                return;
            }
        ...
        private bool HasIn(EventSystemType eventSystemType,string eventType)
        {
            ...
            {
              //  LogHelperLSK.LogError(string.Format("eventSystemType :{0} not contains eventType: {1}",eventSystemType,eventType));
                return false;
            }
            return true;
        }
