...
namespace Char.View
{
    public class Attr: MonoBehaviour
    {
       ...
       // private VerticalLayoutGroup m_vertical;
        ...
        public void Free()
        {
            GameObjectPool.Instance.FreePool(StringDefine.ObjectPooItemKey.CharAttrItem1);
        }
        ...
        public void UpdateInfo(CharAttribute attr)
        {
            ...
            for(int i = 0; i < info.attributeSet.Count; i++)
            {
                ...
                if(dis.attributeCategory == 2)
                    continue;
                GameObject obj =GameObjectPool.Instance.GetObject(StringDefine.ObjectPooItemKey.CharAttrItem1,m_prefab);
                ...
                Utility.AddButtonListener(obj.transform.Find("Btn"),() =>
                {
                    ...
                    //CharAttrTipPanel tipPanel = TipPanelShowUtil.ShowCharAttrTipPanel();
                    //tipPanel.UpdatePos(btn);
                    // EventManager.Instance.TriggerEvent(EventSystemType.UI,EventTypeNameDefine.ShowCharPanelMask);
                });
            }
        }
