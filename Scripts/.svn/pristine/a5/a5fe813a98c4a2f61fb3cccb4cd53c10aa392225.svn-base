...
namespace LskConfig
{
    ...
    public class ConfigManager
    {
        ...
        //配置文件资源路径
        public static string ResPath = "config";
        ...
        public void FormatConfig<T>(out T config) where T : AbsConfig, new()
        {
            ...
            switch (configType)
            {
                ...
                case AbsConfig.E_ConfigType.TXT:
                    ...
                    break;
                default:
                    LogHelperLSK.Log("Error: 没有指定的格式化方法，ConfigType不正确。");
                    break;
            }
        ...
        {
            return TXTHelper.FormatConfig<T>(GetPath(fileName), isResource);
        }
        ...
        {
            return (isResource ? string.Empty : Application.persistentDataPath + "/") + ResPath + fileName;
        }
