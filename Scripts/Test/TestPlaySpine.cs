...
public class TestPlaySpine : MonoBehaviour
{
    ...
    private IEnumerator IEPlay()
    {
        ...
        {
            playIndex = i;
            LogHelperLSK.Log("Play=" + name[playIndex]);
    ...
    private IEnumerator IEPlay1()
    {
      //  yield break;
        ...
        {
            playIndex1 = i;
            LogHelperLSK.Log("Play=" + name1[playIndex1]);
    ...
    {
        LogHelperLSK.Log("Play=" + name[playIndex] + "完成");
        isok = true;
    }
    private void trackentry1(TrackEntry trackEntry)
    {
        LogHelperLSK.LogError("Play=" + name1[playIndex1] + "完成");
        isok1 = true;
    }
    //
